 ...
 */
export function formatCurrency(amount: number | string, currency?: string, locale = "fr-FR"): string {
 ...
 */
export function formatDate(date: Date | string, options?: Intl.DateTimeFormatOptions & { relative?: boolean }): string {
