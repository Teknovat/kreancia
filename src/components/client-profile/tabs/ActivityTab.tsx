    ...
    >
      ...
      <div className="flex-1 pb-8">
        <div
          ...
          className="bg-white rounded-xl border border-slate-200 p-4 hover:shadow-sm transition-shadow duration-200"
        >
    ...
    return (
      <div className="bg-white rounded-xl border border-slate-200 p-12 text-center">
        ...
        <p className="text-slate-600">
          Les interactions et transactions apparaîtront ici au fur et à mesure.
        </p>
      </div>
    )
  }
...
export default function ActivityTab({
  ...
  const filteredActivities = useMemo(() => {
    ...
    if (dateFilter !== 'all') {
      ...
      filtered = filtered.filter(activity =>
        now - activity.timestamp.getTime() < filterMs
      )
    }
